...
describe("Profile Form tests", () => {
    ...
    it("renders", () => {
        renderWithProviders(_jsx(MemoryRouter, { children: _jsx(ProfileForm, { setFileInvalidDate: false, formData: mockFormData, setFormData: () => { }, handleChange: () => { }, hiddenSubmit: () => { }, formHeading: "Update Profile", setIsInvalid: () => { } }) }), {
            preloadedState: {
    ...
    it("renders", () => {
        ...
        expect(screen.getByText("We're missing some information")).toBeInTheDocument();
    });
});
